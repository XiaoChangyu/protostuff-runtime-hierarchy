...
/**
 * Compatible Test. All tag of FIELD of Bean mark with {@link Tag}
 * 兼容性测试. 所有的 Bean 的字段的 tag 由 {@link Tag} 标记.
 * @author: <a href="mailto:676096658@qq.com">xiaochangyu</a>
 */
public class CompatibleTest_Tag {

	public static void main(String[] args) throws Throwable {
		Father father = BeanBuilder_Tag.getFather();
