 ...
 * @created May 20, 2016
 */
public class HierarchyRuntimeGraphUnknownFieldTest extends AbstractTest
{
    ...
    private static <T> byte[] serializeGraph(T object)
    {
        ...
        Schema<T> schema = HierarchyRuntimeSchema.getSchema(clazz);
    ...
    {
        Schema<T> schema = HierarchyRuntimeSchema.getSchema(clz);
