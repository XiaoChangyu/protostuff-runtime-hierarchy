 ...
 * @created Jan 15, 2011
 */
public class HierarchyPolymorphicSerializationTest extends AbstractTest
{
    ...
    {
        Schema<Zoo> schema = HierarchyRuntimeSchema.getSchema(Zoo.class);
        Zoo p = filledZoo();
    ...
    {
        Schema<Zoo> schema = HierarchyRuntimeSchema.getSchema(Zoo.class);
        Pipe.Schema<Zoo> pipeSchema = ((HierarchyRuntimeSchema<Zoo>) schema).getPipeSchema();
        Zoo p = filledZoo();
