...
import io.protostuff.runtime.HierarchyFoo.EnumSample;
 ...
 * @created Nov 13, 2009
 */
public final class HierarchySerializableObjects
{

    public static final HierarchyBaz negativeBaz = new HierarchyBaz(-567, "negativeBaz",
            -202020202);
    public static final HierarchyBar negativeBar = new HierarchyBar(-12, "negativeBar",
            negativeBaz, HierarchyBar.Status.STARTED, ByteString.copyFromUtf8("a1"),
            true, -130.031f, -1000.0001d, -101010101);

    public static final HierarchyBaz hierarchyBaz = new HierarchyBaz(567, "baz", 202020202);
    public static final HierarchyBar hierarchyBar = new HierarchyBar(890, "bar", hierarchyBaz, HierarchyBar.Status.STARTED,
            ByteString.copyFromUtf8("b2"), true, 150.051f, 2000.0002d,
            303030303);

    public static final HierarchyFoo hierarchyFoo = newFoo(
            new Integer[] { 90210, -90210, 0 },
            new String[] { "ab", "cd" },
            new HierarchyBar[] { hierarchyBar, negativeBar },
    ...
    public static HierarchyFoo newFoo(Integer[] someInt, String[] someString,
            HierarchyBar[] someBar, EnumSample[] someEnum, ByteString[] someBytes,
            Boolean[] someBoolean, Float[] someFloat, Double[] someDouble,
            Long[] someLong)
    {

        return new HierarchyFoo(Arrays.asList(someInt), Arrays.asList(someString),
