 ...
 * @created Jan 21, 2011
 */
public class HierarchyInheritanceTest extends AbstractTest
{
    ...
    public void testInheritance() throws IOException
    {
        ...
        {
            System.err
                    .println("HierarchyRuntimeSchema.MORPH_NON_FINAL_POJOS was not enabled.");
            return;
        }
        System.err.println("executing inheritance test for protostuff ... ");

        Schema<InputSystem> schema = HierarchyRuntimeSchema.getSchema(InputSystem.class);
