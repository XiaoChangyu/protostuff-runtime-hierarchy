 ...
 * @author David Yu
 */
public class HierarchyFieldExclusionTest
{
    ...
    {
    	HierarchyRuntimeSchema<EmptyFieldsPojo> schema = HierarchyRuntimeSchema.createFrom(EmptyFieldsPojo.class, RuntimeEnv.ID_STRATEGY);
    ...
    {
        Schema<ComplexFieldsPojo> schema = HierarchyRuntimeSchema
                .getSchema(ComplexFieldsPojo.class);

        HierarchyRuntimeSchema<ComplexFieldsPojo> mappedSchema = (HierarchyRuntimeSchema<ComplexFieldsPojo>) schema;
