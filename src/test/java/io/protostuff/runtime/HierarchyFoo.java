 ...
 * @created Nov 10, 2009
 */
public final class HierarchyFoo implements Externalizable
{
    ...
    private List<HierarchyBar> someBar;
    ...
    public HierarchyFoo(List<Integer> someInt, List<String> someString,
            List<HierarchyBar> someBar, List<EnumSample> someEnum,
     ...
     * @return the someBar
     */
    public List<HierarchyBar> getSomeBar()
    {
        return someBar;
    }
     ...
     *            the someBar to set
     */
    public void setSomeBar(List<HierarchyBar> someBar)
    {
        this.someBar = someBar;
    }
    ...
    public void readExternal(ObjectInput in) throws IOException
    {
        ProtostuffIOUtil.mergeDelimitedFrom(in, this,
                HierarchyRuntimeSchema.getSchema(HierarchyFoo.class));
    }
    ...
    public boolean equals(Object obj)
    {
        ...
        if (getClass() != obj.getClass())
            return false;
        HierarchyFoo other = (HierarchyFoo) obj;
        if (someBar == null)
        {
