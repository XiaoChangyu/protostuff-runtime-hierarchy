 ...
 * @created Jan 19, 2011
 */
public class HierarchyRuntimeGraphTest extends AbstractTest
{
    ...
    {
        Schema<ClubFounder> schema = HierarchyRuntimeSchema.getSchema(ClubFounder.class);
    ...
    {
        Schema<LinkedNodeContainer> schema = HierarchyRuntimeSchema
