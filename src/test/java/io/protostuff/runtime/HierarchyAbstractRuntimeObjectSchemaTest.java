...
import static io.protostuff.runtime.HierarchySampleDelegates.SINGLETON_DELEGATE;
...
import io.protostuff.runtime.HierarchySampleDelegates.ShortArrayDelegate;
import io.protostuff.runtime.HierarchySampleDelegates.Singleton;
 ...
 * @created Feb 3, 2011
 */
public abstract class HierarchyAbstractRuntimeObjectSchemaTest extends AbstractTest
{
    ...
    {
        Schema<Pojo> schema = HierarchyRuntimeSchema.getSchema(Pojo.class);
        Pipe.Schema<Pojo> pipeSchema = ((HierarchyRuntimeSchema<Pojo>) schema).getPipeSchema();
    ...
    {
        Schema<PojoWithArray> schema = HierarchyRuntimeSchema
                .getSchema(PojoWithArray.class);
        Pipe.Schema<PojoWithArray> pipeSchema = ((HierarchyRuntimeSchema<PojoWithArray>) schema).getPipeSchema();
    ...
    {
        Schema<PojoWithArray2D> schema = HierarchyRuntimeSchema
                .getSchema(PojoWithArray2D.class);
        Pipe.Schema<PojoWithArray2D> pipeSchema = ((HierarchyRuntimeSchema<PojoWithArray2D>) schema).getPipeSchema();
    ...
    {
        Schema<PojoWithCollection> schema = HierarchyRuntimeSchema
                .getSchema(PojoWithCollection.class);
        Pipe.Schema<PojoWithCollection> pipeSchema = ((HierarchyRuntimeSchema<PojoWithCollection>) schema).getPipeSchema();
    ...
    {
        Schema<PojoWithMap> schema = HierarchyRuntimeSchema.getSchema(PojoWithMap.class);
        Pipe.Schema<PojoWithMap> pipeSchema = ((HierarchyRuntimeSchema<PojoWithMap>) schema).getPipeSchema();
    ...
    {
        Schema<WrapsBat> schema = HierarchyRuntimeSchema.getSchema(WrapsBat.class);
        Pipe.Schema<WrapsBat> pipeSchema = ((HierarchyRuntimeSchema<WrapsBat>) schema).getPipeSchema();
    ...
    public void testPojoWithCustomArrayListAndHashMapAndHashMap()
            throws Exception
    {
        Schema<PojoWithCustomArrayListAndHashMap> schema = HierarchyRuntimeSchema
                .getSchema(PojoWithCustomArrayListAndHashMap.class);
        Pipe.Schema<PojoWithCustomArrayListAndHashMap> pipeSchema = ((HierarchyRuntimeSchema<PojoWithCustomArrayListAndHashMap>) schema)
                .getPipeSchema();
    ...
    {
        Schema<PojoWithClassFields> schema = HierarchyRuntimeSchema
                .getSchema(PojoWithClassFields.class);
        Pipe.Schema<PojoWithClassFields> pipeSchema = ((HierarchyRuntimeSchema<PojoWithClassFields>) schema).getPipeSchema();
    ...
    {
        Schema<PojoWithObjectCollectionFields> schema = HierarchyRuntimeSchema
                .getSchema(PojoWithObjectCollectionFields.class);
        Pipe.Schema<PojoWithObjectCollectionFields> pipeSchema = ((HierarchyRuntimeSchema<PojoWithObjectCollectionFields>) schema)
                .getPipeSchema();
    ...
    {
        Schema<PojoWithObjectCollectionNullKV> schema = HierarchyRuntimeSchema
                .getSchema(PojoWithObjectCollectionNullKV.class);
        Pipe.Schema<PojoWithObjectCollectionNullKV> pipeSchema = ((HierarchyRuntimeSchema<PojoWithObjectCollectionNullKV>) schema)
                .getPipeSchema();
    ...
    {
        Schema<PojoWithObjectMapFields> schema = HierarchyRuntimeSchema
                .getSchema(PojoWithObjectMapFields.class);
        Pipe.Schema<PojoWithObjectMapFields> pipeSchema = ((HierarchyRuntimeSchema<PojoWithObjectMapFields>) schema)
                .getPipeSchema();
    ...
    {
        Schema<PojoWithSingletonMapNullKV> schema = HierarchyRuntimeSchema
                .getSchema(PojoWithSingletonMapNullKV.class);
        Pipe.Schema<PojoWithSingletonMapNullKV> pipeSchema = ((HierarchyRuntimeSchema<PojoWithSingletonMapNullKV>) schema)
                .getPipeSchema();
    ...
    {
        Schema<PojoWithThrowable> schema = HierarchyRuntimeSchema
                .getSchema(PojoWithThrowable.class);
        Pipe.Schema<PojoWithThrowable> pipeSchema = ((HierarchyRuntimeSchema<PojoWithThrowable>) schema).getPipeSchema();
    ...
    {
        Schema<PojoWithThrowableArray> schema = HierarchyRuntimeSchema
                .getSchema(PojoWithThrowableArray.class);
        Pipe.Schema<PojoWithThrowableArray> pipeSchema = ((HierarchyRuntimeSchema<PojoWithThrowableArray>) schema)
                .getPipeSchema();
    ...
    public void testPojoWithSingletonAsDelegate() throws Exception
    {
        ...
        Schema<PojoWithSingletonAsDelegate> schema = HierarchyRuntimeSchema
                .getSchema(PojoWithSingletonAsDelegate.class);
        Pipe.Schema<PojoWithSingletonAsDelegate> pipeSchema = ((HierarchyRuntimeSchema<PojoWithSingletonAsDelegate>) schema)
                .getPipeSchema();
    ...
    public void testPojoWithShortArrayAsDelegate() throws Exception
    {
        ...
        Schema<PojoWithShortArrayAsDelegate> schema = HierarchyRuntimeSchema
                .getSchema(PojoWithShortArrayAsDelegate.class);
        Pipe.Schema<PojoWithShortArrayAsDelegate> pipeSchema = ((HierarchyRuntimeSchema<PojoWithShortArrayAsDelegate>) schema)
                .getPipeSchema();
