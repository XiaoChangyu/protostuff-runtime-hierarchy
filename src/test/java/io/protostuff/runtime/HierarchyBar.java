 ...
 * @created Nov 10, 2009
 */
public final class HierarchyBar implements Externalizable
{
    ...
    public HierarchyBar(int someInt, String someString, HierarchyBaz hierarchyBaz, Status someEnum,
            ByteString someBytes, boolean someBoolean, float someFloat,
            double someDouble, long someLong)
    {
        this.someInt = someInt;
        this.someString = someString;
        this.someBaz = hierarchyBaz;
     ...
     * @return the someBaz
     */
    public HierarchyBaz getSomeBaz()
    {
        return someBaz;
    }
     ...
     *            the someBaz to set
     */
    public void setSomeBaz(HierarchyBaz hierarchyBaz)
    {
        this.someBaz = hierarchyBaz;
    }
    ...
    public void readExternal(ObjectInput in) throws IOException
    {
        ProtostuffIOUtil.mergeDelimitedFrom(in, this,
                HierarchyRuntimeSchema.getSchema(HierarchyBar.class));
    }
    ...
    public boolean equals(Object obj)
    {
        ...
        if (getClass() != obj.getClass())
            return false;
        HierarchyBar other = (HierarchyBar) obj;
        if (someBaz == null)
        {
