 ...
 * @created Jan 19, 2011
 */
public class HierarchyPolymorphicRuntimeGraphTest extends AbstractTest
{
    ...
    public static void main(String[] args) throws Throwable {
    	new HierarchyPolymorphicRuntimeGraphTest().testPolymorphicAndCyclic();
	}
    /*
     * Scenario:
     * 
    ...
    {
        Schema<HtmlDocumentRequest> schema = HierarchyRuntimeSchema
    ...
    {
        Schema<LinkedElementContainer> schema = HierarchyRuntimeSchema
