...
public class HierarchyCollectionTest
{
    ...
    static
    {
        ...
        // serialization.
        HierarchyRuntimeSchema.map(ITask.class, Task.class);
        HierarchyRuntimeSchema.map(AbstractEmployee.class, Employee.class);
    }
    ...
    {
        Schema<Task> schema = HierarchyRuntimeSchema.getSchema(Task.class);
    ...
    public void testITask() throws Exception
    {
        ...
        Schema<ITask> schema = HierarchyRuntimeSchema.getSchema(ITask.class);
    ...
    {
        Schema<Employee> schema = HierarchyRuntimeSchema.getSchema(Employee.class);
    ...
    public void testIEmployee() throws Exception
    {
        ...
        Schema<AbstractEmployee> schema = HierarchyRuntimeSchema
    ...
    {
    	HierarchyRuntimeSchema<PojoWithMappedAbstractTypes> schema = (HierarchyRuntimeSchema<PojoWithMappedAbstractTypes>) HierarchyRuntimeSchema
