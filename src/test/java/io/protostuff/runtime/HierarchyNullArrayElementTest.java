 ...
 * @created Sep 29, 2014
 */
public abstract class HierarchyNullArrayElementTest extends AbstractTest
{
    ...
    public void testNullAll() throws IOException
    {
        ...
        Schema<PojoWithNonPrimitiveArrays> schema =
                HierarchyRuntimeSchema.getSchema(PojoWithNonPrimitiveArrays.class);

        Pipe.Schema<PojoWithNonPrimitiveArrays> pipeSchema =
                ((HierarchyRuntimeSchema<PojoWithNonPrimitiveArrays>) schema).getPipeSchema();
    ...
    public void testArrayInList() throws IOException
    {
        Schema<PojoWithArrayInList> schema =
                HierarchyRuntimeSchema.getSchema(PojoWithArrayInList.class);

        Pipe.Schema<PojoWithArrayInList> pipeSchema =
                ((HierarchyRuntimeSchema<PojoWithArrayInList>) schema).getPipeSchema();
    ...
    public void testArrayPrimitiveInList() throws IOException
    {
        Schema<PojoWithArrayPrimitiveInList> schema =
                HierarchyRuntimeSchema.getSchema(PojoWithArrayPrimitiveInList.class);

        Pipe.Schema<PojoWithArrayPrimitiveInList> pipeSchema =
                ((HierarchyRuntimeSchema<PojoWithArrayPrimitiveInList>) schema).getPipeSchema();
    ...
    public void testArrayInMap() throws IOException
    {
        Schema<PojoWithArrayInMap> schema =
                HierarchyRuntimeSchema.getSchema(PojoWithArrayInMap.class);

        Pipe.Schema<PojoWithArrayInMap> pipeSchema =
                ((HierarchyRuntimeSchema<PojoWithArrayInMap>) schema).getPipeSchema();
    ...
    public void testArrayPrimitiveInMap() throws IOException
    {
        Schema<PojoWithArrayPrimitiveInMap> schema =
                HierarchyRuntimeSchema.getSchema(PojoWithArrayPrimitiveInMap.class);

        Pipe.Schema<PojoWithArrayPrimitiveInMap> pipeSchema =
                ((HierarchyRuntimeSchema<PojoWithArrayPrimitiveInMap>) schema).getPipeSchema();
